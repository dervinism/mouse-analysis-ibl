% Figures exploring quantifying correlated and anticorrelated cells in different brain areas
...
for iAnimal = 1:numel(animalNames)
  ...
  for iArea = 1:numel(brainAreas)
    ...
    rSpearman_BrainArea = ...
      infraslowAnalyses.spikingPupilCorr.(animalName).(areaName).rSpearman;
